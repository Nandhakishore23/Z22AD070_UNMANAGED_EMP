...
*ENDCLASS.
*
*CLASS lsc_Z22AD071_I_EMP DEFINITION INHERITING FROM cl_abap_behavior_saver.
*  PROTECTED SECTION.
*
...
*ENDCLASS.
*
*CLASS lsc_Z22AD071_I_EMP IMPLEMENTATION.
*
*  METHOD finalize.
*  ENDMETHOD.
*
...
CLASS lhc_EMP IMPLEMENTATION.
 ...
 DATA ls_employee TYPE Z22AD071_EMP.
 ...
 ENDMETHOD.
ENDCLASS.
CLASS lsc_Z22AD071_I_EMP DEFINITION
...
CLASS lsc_Z22AD071_I_EMP IMPLEMENTATION.
 ...
 CASE <ls_buf>-flag.
 WHEN 'C'.
 INSERT Z22AD071_EMP FROM @<ls_buf>-lv_data.
 WHEN 'U'.
 UPDATE Z22AD071_EMP FROM @<ls_buf>-lv_data.
 WHEN 'D'.
 DELETE FROM Z22AD071_EMP
